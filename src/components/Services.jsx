...
function Services() {
  ...
  return (
    ...
    <div data-scroll data-scroll-section data-scroll-speed = "-.1"  id="services" className=" sm:w-full w-[100%] sm:h-[80vh] h-[90vh]  pb-20 sm:-mt-20 -mt-24 bg-[#9fb748] rounded-tl-3xl rounded-tr-3xl text-black">
